...
`,[Z("strong",`
 ...
 `,[At({originalTransition:"background-color .3s var(--n-bezier), box-shadow .3s var(--n-bezier)"})])]),Mo=Object.assign(Object.assign({},me.props),{to:bt.propTo,bordered:{type:Boolean,default:void 0},clearable:Boolean,clearFilterAfterSelect:{type:Boolean,default:!0},options:{type:Array,default:()=>[]},defaultValue:{type:[String,Number,Array],default:null},keyboard:{type:Boolean,default:!0},value:[String,Number,Array],placeholder:String,menuProps:Object,multiple:Boolean,size:String,menuSize:{type:String},filterable:Boolean,disabled:{type:Boolean,default:void 0},remote:Boolean,loading:Boolean,filter:Function,placement:{type:String,default:"bottom-start"},widthMode:{type:String,default:"trigger"},tag:Boolean,onCreate:Function,fallbackOption:{type:[Function,Boolean],default:void 0},show:{type:Boolean,default:void 0},showArrow:{type:Boolean,default:!0},maxTagCount:[Number,String],ellipsisTagPopoverProps:Object,consistentMenuWidth:{type:Boolean,default:!0},virtualScroll:{type:Boolean,default:!0},labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},childrenField:{type:String,default:"children"},renderLabel:Function,renderOption:Function,renderTag:Function,"onUpdate:value":[Function,Array],inputProps:Object,nodeProps:Function,ignoreComposition:{type:Boolean,default:!0},showOnFocus:Boolean,onUpdateValue:[Function,Array],onBlur:[Function,Array],onClear:[Function,Array],onFocus:[Function,Array],onScroll:[Function,Array],onSearch:[Function,Array],onUpdateShow:[Function,Array],"onUpdate:show":[Function,Array],displayDirective:{type:String,default:"show"},resetMenuOnOptionsChange:{type:Boolean,default:!0},status:String,showCheckmark:{type:Boolean,default:!0},onChange:[Function,Array],items:Array}),vt=ce({name:"Select",props:Mo,slots:Object,setup(e){const{mergedClsPrefixRef:n,mergedBorderedRef:o,namespaceRef:l,inlineThemeDisabled:i}=je(e),u=me("Select","-select",Io,Un,e,n),f=T(e.defaultValue),r=te(e,"value"),m=kt(r,f),g=T(!1),p=T(""),S=Kn(e,["items","options"]),k=T([]),h=T([]),x=O(()=>h.value.concat(k.value).concat(S.value)),P=O(()=>{const{filter:t}=e;if(t)return t;const{labelField:v,valueField:z}=e;return(V,E)=>{if(!E)return!1;const _=E[v];if(typeof _=="string")return ht(V,_);const N=E[z];return typeof N=="string"?ht(V,N):typeof N=="number"?ht(V,String(N)):!1}}),L=O(()=>{if(e.remote)return S.value;{const{value:t}=x,{value:v}=p;return!v.length||!e.filterable?t:To(t,P.value,v,e.childrenField)}}),F=O(()=>{const{valueField:t,childrenField:v}=e,z=zo(t,v);return qn(L.value,z)}),M=O(()=>Oo(x.value,e.valueField,e.childrenField)),W=T(!1),w=kt(te(e,"show"),W),R=T(null),I=T(null),H=T(null),{localeRef:fe}=Dt("Select"),he=O(()=>{var t;return(t=e.placeholder)!==null&&t!==void 0?t:fe.value.placeholder}),se=[],ne=T(new Map),de=O(()=>{const{fallbackOption:t}=e;if(t===void 0){const{labelField:v,valueField:z}=e;return V=>({[v]:String(V),[z]:V})}return t===!1?!1:v=>Object.assign(t(v),{value:v})});function d(t){const v=e.remote,{value:z}=ne,{value:V}=M,{value:E}=de,_=[];return t.forEach(N=>{if(V.has(N))_.push(V.get(N));else if(v&&z.has(N))_.push(z.get(N));else if(E){const Q=E(N);Q&&_.push(Q)}}),_}const C=O(()=>{if(e.multiple){const{value:t}=m;return Array.isArray(t)?d(t):[]}return null}),$=O(()=>{const{value:t}=m;return!e.multiple&&!Array.isArray(t)?t===null?null:d([t])[0]||null:null}),U=Gn(e),{mergedSizeRef:G,mergedDisabledRef:K,mergedStatusRef:q}=U;function D(t,v){const{onChange:z,"onUpdate:value":V,onUpdateValue:E}=e,{nTriggerFormChange:_,nTriggerFormInput:N}=U;z&&be(z,t,v),E&&be(E,t,v),V&&be(V,t,v),f.value=t,_(),N()}function Y(t){const{onBlur:v}=e,{nTriggerFormBlur:z}=U;v&&be(v,t),z()}function c(){const{onClear:t}=e;t&&be(t)}function b(t){const{onFocus:v,showOnFocus:z}=e,{nTriggerFormFocus:V}=U;v&&be(v,t),V(),z&&ve()}function j(t){const{onSearch:v}=e;v&&be(v,t)}function le(t){const{onScroll:v}=e;v&&be(v,t)}function we(){var t;const{remote:v,multiple:z}=e;if(v){const{value:V}=ne;if(z){const{valueField:E}=e;(t=C.value)===null||t===void 0||t.forEach(_=>{V.set(_[E],_)})}else{const E=$.value;E&&V.set(E[e.valueField],E)}}}function ye(t){const{onUpdateShow:v,"onUpdate:show":z}=e;v&&be(v,t),z&&be(z,t),W.value=t}function ve(){K.value||(ye(!0),W.value=!0,e.filterable&&Ke())}function ie(){ye(!1)}function Ce(){p.value="",h.value=se}const ue=T(!1);function _e(){e.filterable&&(ue.value=!0)}function Be(){e.filterable&&(ue.value=!1,w.value||Ce())}function $e(){K.value||(w.value?e.filterable?Ke():ie():ve())}function Ee(t){var v,z;!((z=(v=H.value)===null||v===void 0?void 0:v.selfRef)===null||z===void 0)&&z.contains(t.relatedTarget)||(g.value=!1,Y(t),ie())}function Se(t){b(t),g.value=!0}function ke(){g.value=!0}function Ne(t){var v;!((v=R.value)===null||v===void 0)&&v.$el.contains(t.relatedTarget)||(g.value=!1,Y(t),ie())}function Le(){var t;(t=R.value)===null||t===void 0||t.focus(),ie()}function Ae(t){var v;w.value&&(!((v=R.value)===null||v===void 0)&&v.$el.contains(Yn(t))||ie())}function Oe(t){if(!Array.isArray(t))return[];if(de.value)return Array.from(t);{const{remote:v}=e,{value:z}=M;if(v){const{value:V}=ne;return t.filter(E=>z.has(E)||V.has(E))}else return t.filter(V=>z.has(V))}}function Fe(t){re(t.rawNode)}function re(t){if(K.value)return;const{tag:v,remote:z,clearFilterAfterSelect:V,valueField:E}=e;if(v&&!z){const{value:_}=h,N=_[0]||null;if(N){const Q=k.value;Q.length?Q.push(N):k.value=[N],h.value=se}}if(z&&ne.value.set(t[E],t),e.multiple){const _=Oe(m.value),N=_.findIndex(Q=>Q===t[E]);if(~N){if(_.splice(N,1),v&&!z){const Q=s(t[E]);~Q&&(k.value.splice(Q,1),V&&(p.value=""))}}else _.push(t[E]),V&&(p.value="");D(_,d(_))}else{if(v&&!z){const _=s(t[E]);~_?k.value=[k.value[_]]:k.value=se}Ue(),ie(),D(t[E],t)}}function s(t){return k.value.findIndex(z=>z[e.valueField]===t)}function y(t){w.value||ve();const{value:v}=t.target;p.value=v;const{tag:z,remote:V}=e;if(j(v),z&&!V){if(!v){h.value=se;return}const{onCreate:E}=e,_=E?E(v):{[e.labelField]:v,[e.valueField]:v},{valueField:N,labelField:Q}=e;S.value.some(pe=>pe[N]===_[N]||pe[Q]===_[Q])||k.value.some(pe=>pe[N]===_[N]||pe[Q]===_[Q])?h.value=se:h.value=[_]}}function J(t){t.stopPropagation();const{multiple:v}=e;!v&&e.filterable&&ie(),c(),v?D([],[]):D(null,null)}function ot(t){!De(t,"action")&&!De(t,"empty")&&!De(t,"header")&&t.preventDefault()}function lt(t){le(t)}function We(t){var v,z,V,E,_;if(!e.keyboard){t.preventDefault();return}switch(t.key){case" ":if(e.filterable)break;t.preventDefault();case"Enter":if(!(!((v=R.value)===null||v===void 0)&&v.isComposing)){if(w.value){const N=(z=H.value)===null||z===void 0?void 0:z.getPendingTmNode();N?Fe(N):e.filterable||(ie(),Ue())}else if(ve(),e.tag&&ue.value){const N=h.value[0];if(N){const Q=N[e.valueField],{value:pe}=m;e.multiple&&Array.isArray(pe)&&pe.includes(Q)||re(N)}}}t.preventDefault();break;case"ArrowUp":if(t.preventDefault(),e.loading)return;w.value&&((V=H.value)===null||V===void 0||V.prev());break;case"ArrowDown":if(t.preventDefault(),e.loading)return;w.value?(E=H.value)===null||E===void 0||E.next():ve();break;case"Escape":w.value&&(uo(t),ie()),(_=R.value)===null||_===void 0||_.focus();break}}function Ue(){var t;(t=R.value)===null||t===void 0||t.focus()}function Ke(){var t;(t=R.value)===null||t===void 0||t.focusInput()}function it(){var t;w.value&&((t=I.value)===null||t===void 0||t.syncPosition())}we(),xe(te(e,"options"),we);const rt={focus:()=>{var t;(t=R.value)===null||t===void 0||t.focus()},focusInput:()=>{var t;(t=R.value)===null||t===void 0||t.focusInput()},blur:()=>{var t;(t=R.value)===null||t===void 0||t.blur()},blurInput:()=>{var t;(t=R.value)===null||t===void 0||t.blurInput()}},qe=O(()=>{const{self:{menuBoxShadow:t}}=u.value;return{"--n-menu-box-shadow":t}}),Re=i?He("select",void 0,qe,e):void 0;return Object.assign(Object.assign({},rt),{mergedStatus:q,mergedClsPrefix:n,mergedBordered:o,namespace:l,treeMate:F,isMounted:Xn(),triggerRef:R,menuRef:H,pattern:p,uncontrolledShow:W,mergedShow:w,adjustedTo:bt(e),uncontrolledValue:f,mergedValue:m,followerRef:I,localizedPlaceholder:he,selectedOption:$,selectedOptions:C,mergedSize:G,mergedDisabled:K,focused:g,activeWithoutMenuOpen:ue,inlineThemeDisabled:i,onTriggerInputFocus:_e,onTriggerInputBlur:Be,handleTriggerOrMenuResize:it,handleMenuFocus:ke,handleMenuBlur:Ne,handleMenuTabOut:Le,handleTriggerClick:$e,handleToggle:Fe,handleDeleteOption:re,handlePatternInput:y,handleClear:J,handleTriggerBlur:Ee,handleTriggerFocus:Se,handleKeydown:We,handleMenuAfterLeave:Ce,handleMenuClickOutside:Ae,handleMenuScroll:lt,handleMenuKeydown:We,handleMenuMousedown:ot,mergedTheme:u,cssVars:i?void 0:qe,themeClass:Re?.themeClass,onRender:Re?.onRender})},render(){return a("div",{class:`${this.mergedClsPrefix}-select`},a(Vn,null,{default:()=>[a(Dn,null,{default:()=>a(Fo,{ref:"triggerRef",inlineThemeDisabled:this.inlineThemeDisabled,status:this.mergedStatus,inputProps:this.inputProps,clsPrefix:this.mergedClsPrefix,showArrow:this.showArrow,maxTagCount:this.maxTagCount,ellipsisTagPopoverProps:this.ellipsisTagPopoverProps,bordered:this.mergedBordered,active:this.activeWithoutMenuOpen||this.mergedShow,pattern:this.pattern,placeholder:this.localizedPlaceholder,selectedOption:this.selectedOption,selectedOptions:this.selectedOptions,multiple:this.multiple,renderTag:this.renderTag,renderLabel:this.renderLabel,filterable:this.filterable,clearable:this.clearable,disabled:this.mergedDisabled,size:this.mergedSize,theme:this.mergedTheme.peers.InternalSelection,labelField:this.labelField,valueField:this.valueField,themeOverrides:this.mergedTheme.peerOverrides.InternalSelection,loading:this.loading,focused:this.focused,onClick:this.handleTriggerClick,onDeleteOption:this.handleDeleteOption,onPatternInput:this.handlePatternInput,onClear:this.handleClear,onBlur:this.handleTriggerBlur,onFocus:this.handleTriggerFocus,onKeydown:this.handleKeydown,onPatternBlur:this.onTriggerInputBlur,onPatternFocus:this.onTriggerInputFocus,onResize:this.handleTriggerOrMenuResize,ignoreComposition:this.ignoreComposition},{arrow:()=>{var e,n;return[(n=(e=this.$slots).arrow)===null||n===void 0?void 0:n.call(e)]}})}),a(jn,{ref:"followerRef",show:this.mergedShow,to:this.adjustedTo,teleportDisabled:this.adjustedTo===bt.tdkey,containerClass:this.namespace,width:this.consistentMenuWidth?"target":void 0,minWidth:"target",placement:this.placement},{default:()=>a(Lt,{name:"fade-in-scale-up-transition",appear:this.isMounted,onAfterLeave:this.handleMenuAfterLeave},{default:()=>{var e,n,o;return this.mergedShow||this.displayDirective==="show"?((e=this.onRender)===null||e===void 0||e.call(this),Hn(a(xo,Object.assign({},this.menuProps,{ref:"menuRef",onResize:this.handleTriggerOrMenuResize,inlineThemeDisabled:this.inlineThemeDisabled,virtualScroll:this.consistentMenuWidth&&this.virtualScroll,class:[`${this.mergedClsPrefix}-select-menu`,this.themeClass,(n=this.menuProps)===null||n===void 0?void 0:n.class],clsPrefix:this.mergedClsPrefix,focusable:!0,labelField:this.labelField,valueField:this.valueField,autoPending:!0,nodeProps:this.nodeProps,theme:this.mergedTheme.peers.InternalSelectMenu,themeOverrides:this.mergedTheme.peerOverrides.InternalSelectMenu,treeMate:this.treeMate,multiple:this.multiple,size:this.menuSize,renderOption:this.renderOption,renderLabel:this.renderLabel,value:this.mergedValue,style:[(o=this.menuProps)===null||o===void 0?void 0:o.style,this.cssVars],onToggle:this.handleToggle,onScroll:this.handleMenuScroll,onFocus:this.handleMenuFocus,onBlur:this.handleMenuBlur,onKeydown:this.handleMenuKeydown,onTabOut:this.handleMenuTabOut,onMousedown:this.handleMenuMousedown,show:this.mergedShow,showCheckmark:this.showCheckmark,resetMenuOnOptionsChange:this.resetMenuOnOptionsChange}),{empty:()=>{var l,i;return[(i=(l=this.$slots).empty)===null||i===void 0?void 0:i.call(l)]},header:()=>{var l,i;return[(i=(l=this.$slots).header)===null||i===void 0?void 0:i.call(l)]},action:()=>{var l,i;return[(i=(l=this.$slots).action)===null||i===void 0?void 0:i.call(l)]}}),this.displayDirective==="show"?[[Wn,this.mergedShow],[St,this.handleMenuClickOutside,void 0,{capture:!0}]]:[[St,this.handleMenuClickOutside,void 0,{capture:!0}]])):null}})})]}))}}),Po={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},_o=ce({name:"OpenInNewFilled",render:function(n,o){return Je(),pt("svg",Po,o[0]||(o[0]=[Ze("path",{d:"M19 19H5V5h7V3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83l1.41 1.41L19 6.41V10h2V3h-7z",fill:"currentColor"},null,-1)]))}}),Bo={class:"p-4"},$o={class:"mt-2"},Eo={key:0},No={class:"mt-4"},jo=ce({__name:"FirmwareView",setup(e){const{data:n,isPending:o}=Ft(Ot.pet.getFirmwares,{}),{data:l,isPending:i}=Ft(Ot.pet.getSources,{}),u=T(0),f=T(null),r=T(""),m=T(""),{selectedSourceId:g}=Zn(oo()),p=[{label:"中国大陆",value:0},{label:"海外版",value:1}],S=O(()=>l.value?l.value.map(w=>({label:w.name,value:w._id})):[]),k=O(()=>n.value?n.value.map(w=>({label:w.name??w.fileName,value:w._id})):[]),h=T([]),x=O(()=>h.value.map(w=>`[${w.time}] SN: ${w.sn} ${w.result}`).join(`
`)),P=w=>{h.value.unshift({id:`${Date.now()}-${Math.random().toString(16).slice(2)}`,time:new Date().toLocaleTimeString("en-US",{hour12:!1,hour:"2-digit",minute:"2-digit",second:"2-digit"}),sn:r.value||"-",result:w})},L=O(()=>{if(!f.value||!g||!r.value)return"";const w=n.value?.find(I=>I._id===f.value),R=l.value?.find(I=>I._id===g.value);return!w||!R?"":u.value===0?`https://gw.pick-fun.com.cn/device/test/mqtt/upgrade?md5=${w.md5}&size=${w.size}&url=${encodeURIComponent(R.baseUrl+w.fileName)}&sn=${r.value}&test-verify=1111`:`https://gw.pick-fun.com/device/test/mqtt/upgrade?md5=${w.md5}&size=${w.size}&url=${encodeURIComponent(R.baseUrl+w.fileName)}&sn=${r.value}&test-verify=1111`}),F=O(()=>{if(!f.value||!g.value)return"";const w=n.value?.find(I=>I._id===f.value),R=l.value?.find(I=>I._id===g.value);return!w||!R?"":`${R.baseUrl}${w.fileName}`});xe(n,()=>{n.value?.find(w=>w._id===f.value)||(f.value=null)}),xe(l,()=>{l.value?.find(w=>w._id===g.value)||(g.value=null)});const M=async w=>{w.preventDefault();try{m.value="升级中...";const I=await(await fetch(L.value,{headers:{"Accept-Language":"zh-CN"}})).json(),H=JSON.stringify(I,null,2);m.value=H,P(I.message)}catch(R){const I=`错误: ${R}`;m.value=I,P(I)}},W=async w=>{w.preventDefault();try{const R=window.open(F.value,"_blank","noopener,noreferrer");if(R){R.focus?.(),m.value="Opened firmware URL in a new window";return}const I=document.createElement("a");I.href=F.value,I.target="_blank",I.rel="noopener noreferrer",document.body.appendChild(I),I.click(),I.remove()}catch(R){m.value=`Error: ${R}`}};return(w,R)=>{const I=to("NIcon");return Je(),pt("div",Bo,[Ze("div",$o,[ee(o)||ee(i)?(Je(),pt("div",Eo,"Loading...")):(Je(),Jn(ee(no),{key:1,inline:"","label-width":180},{default:ge(()=>[oe(ee(Ie),{path:"md5",label:"SN"},{default:ge(()=>[oe(ee(dt),{value:r.value,"onUpdate:value":R[0]||(R[0]=H=>r.value=H),valueModifiers:{trim:!0},placeholder:"输入序列号"},null,8,["value"])]),_:1}),oe(ee(Ie),{path:"md5",label:"当前版本"},{default:ge(()=>[oe(ee(vt),{value:u.value,"onUpdate:value":R[1]||(R[1]=H=>u.value=H),options:p,style:{"min-width":"180px"},placeholder:"选择版本"},null,8,["value"])]),_:1}),oe(ee(Ie),{path:"size",label:"目标固件版本"},{default:ge(()=>[oe(ee(vt),{value:f.value,"onUpdate:value":R[2]||(R[2]=H=>f.value=H),options:k.value,style:{"min-width":"180px"},placeholder:"选择目标固件版本"},null,8,["value","options"])]),_:1}),oe(ee(Ie),{ref:"rPasswordFormItemRef",first:"",path:"Source",label:"固件存储来源"},{default:ge(()=>[oe(ee(vt),{value:ee(g),"onUpdate:value":R[3]||(R[3]=H=>eo(g)?g.value=H:null),options:S.value,style:{"min-width":"180px"},placeholder:"选择固件存储来源"},null,8,["value","options"])]),_:1},512),oe(ee(Ie),null,{default:ge(()=>[oe(ee(zt),{type:"primary",disabled:!L.value,onClick:M},{default:ge(()=>R[5]||(R[5]=[Tt(" 推送升级包 ")])),_:1},8,["disabled"])]),_:1}),oe(ee(Ie),null,{default:ge(()=>[oe(ee(zt),{disabled:!F.value,onClick:W},{icon:ge(()=>[oe(I,null,{default:ge(()=>[oe(ee(_o))]),_:1})]),default:ge(()=>[R[6]||(R[6]=Tt(" 测试固件下载 "))]),_:1},8,["disabled"])]),_:1})]),_:1})),Ze("p",null,Qn(L.value),1),oe(ee(dt),{value:m.value,"onUpdate:value":R[4]||(R[4]=H=>m.value=H),type:"textarea",placeholder:"推送结果",readonly:"",autosize:{minRows:8}},null,8,["value"])]),Ze("div",No,[oe(ee(dt),{value:x.value,type:"textarea",placeholder:"升级日志",readonly:"",style:{height:"300px",overflow:"auto"}},null,8,["value"])])])}}});export{jo as default};
